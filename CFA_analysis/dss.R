...
library('semPlot')
library('semTools')
global_items <- read.csv('/Users/stolbert/code/self-driving-car-subjective-sampling-data-analysis/data-cleaning/scales/dss_global.csv')
...
model <- 'DSS=~ x2+x3+x4+x6+x8+x9+x10
x2~~x10
'
