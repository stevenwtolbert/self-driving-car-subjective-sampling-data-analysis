...
library('semPlot')
library('semTools')
global_items <- read.csv('/Users/stolbert/code/self-driving-car-subjective-sampling-data-analysis/data-cleaning/scales/global_items.csv')
...
model <- 'DBA=~ x1+x2+x3+x4+x7+x8+x9
x1~~x9
x2~~x9
x3~~x8
'
