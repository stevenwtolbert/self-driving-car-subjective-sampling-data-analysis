...
library('semPlot')
library('semTools')
global_items <- read.csv('/Users/stolbert/code/self-driving-car-subjective-sampling-data-analysis/data-cleaning/scales/ait_global.csv')
